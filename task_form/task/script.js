...
FORM_ENUMS.GENDER.forEach(function (gender, index) {
...
resetButton.addEventListener("click", function (event) {
    try {
        ...
        document.querySelectorAll(".review-list .value").forEach(function (valueElement) {
